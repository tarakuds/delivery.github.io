    ...
    ce.fn.extend({
      data: function (e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((o = ce.data(u)), 1 === u.nodeType && !ce._data(u, "parsedAttrs"))
          ) {
            for (r = u.attributes; s < r.length; s++)
              (i = r[s].name),
                0 === i.indexOf("data-") &&
                  ((i = ce.camelCase(i.slice(5))), a(u, i, o[i]));
    ...
    trigger: function (n, r, i, o) {
      ...
      if (
        ...
        if (!o && !c.noBubble && !ce.isWindow(i)) {
          for (
            l = c.delegateType || h, Re.test(l + h) || (u = u.parentNode);
            u;
            u = u.parentNode
          )
            d.push(u), (f = u);
        ...
        for (p = 0; (u = d[p++]) && !n.isPropagationStopped(); )
          (n.type = p > 1 ? l : c.bindType || h),
            (a =
              (ce._data(u, "events") || {})[n.type] && ce._data(u, "handle")),
            a && a.apply(u, r),
            (a = s && u[s]),
            a &&
              ce.acceptData(u) &&
  ...
  (at.optgroup = at.option),
    ...
    ce.fn.extend({
      ...
      domManip: function (e, t, n) {
        ...
        if (
          c &&
          ((u = ce.buildFragment(e, this[0].ownerDocument, !1, !n && this)),
          (r = u.firstChild),
          ...
          if (o)
            for (
              s = a[a.length - 1].ownerDocument, ce.map(a, m), l = 0;
              o > l;
              l++
            )
              (i = a[l]),
            ...
            if ("object" === ce.type(o)) ce.merge(h, o.nodeType ? [o] : o);
              ...
              if (
                ...
                for (
                  ...
                  ce.nodeName((l = o.childNodes[i]), "tbody") &&
                    !l.childNodes.length &&
                    o.removeChild(l);
              for (
    ...
    ce.extend({
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
            ...
            l = e.style;
          if (
            ((n = ce.cssProps[u] || (ce.cssProps[u] = T(l, u))),
            (s = ce.cssHooks[n] || ce.cssHooks[u]),
            r === t)
          )
      ...
      css: function (e, n, r, i) {
        var o,
          ...
          u = ce.camelCase(n);
        return (
          (n = ce.cssProps[u] || (ce.cssProps[u] = T(e.style, u))),
          (s = ce.cssHooks[n] || ce.cssHooks[u]),
